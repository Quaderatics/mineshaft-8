...
execute if entity @s[y_rotation=-90..90] positioned ~-0.5 ~-0.5 ~-0.5 as @e[type=!minecraft:player,tag=!title_text,dx=15,dy=13,dz=47] run function mineshaft8:remove_entity
execute unless entity @s[y_rotation=-90..90] positioned ~-15.5 ~-0.5 ~-47.5 as @e[type=!minecraft:player,tag=!title_text,dx=15,dy=13,dz=47] run function mineshaft8:remove_entity
